...
src/ui/          React components: MenuBar with SessionHeader details, DropZone, ContextGrid, ContextLegend, ContextWindowPanel, Inspector, Scrubber; Workbench grid and Cell-fit layout, filters, formatting, theme token maps
